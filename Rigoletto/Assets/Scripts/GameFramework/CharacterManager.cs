    ...
    public class CharacterManager : MonoBehaviour
    {
        ...
        public void ConstructNewCharacter(GameObject characterPrefab,bool bCanDuplicated = false, bool bNeedRebindCamera = false)
        {
            if (bCanDuplicated)
            {
                ...
                Singleton.Instance.SaveLoadManager.SaveCharacterData( temp1.GetComponentInChildren<BaseCharacter>().dataToSave.characterID,temp1.GetComponentInChildren<BaseCharacter>().dataToSave,temp1.transform);
            ...
            Singleton.Instance.SaveLoadManager.SaveCharacterData( temp2.GetComponentInChildren<BaseCharacter>().dataToSave.characterID,temp2.GetComponentInChildren<BaseCharacter>().dataToSave,temp2.transform);
